...
/// </remarks>
public class ModifiedCardboardReticlePointer : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Checks for screen touches.
        input.Player.Choose.performed += ctx => Clicked();
